...
static glm::vec3 lightDirection = glm::normalize(glm::vec3(-275.0f, 500.0f, -275.0f));
...
struct Building {
    ...
    void initialize(glm::vec3 position, glm::vec3 scale, const std::string& textureFilePath) {
        ...
        modelUniform = glGetUniformLocation(buildingProgramID, "model");
    ...
    void render(glm::mat4 cameraMatrix, glm::vec3 lightDirection, glm::vec3 lightIntensity ) {
...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // Render Buildings
        glUseProgram(buildingProgramID);
        glUniform3fv(glGetUniformLocation(buildingProgramID, "lightDirection"), 1, &lightDirection[0]);
        glUniform3fv(glGetUniformLocation(buildingProgramID, "lightIntensity"), 1, &lightIntensity[0]);
        ...
        for (auto& building : buildings) {
            ...
            // Render the building
            building.render(vp, lightDirection, lightIntensity);
        }
