...
int main() {
    ...
    // Handle camera movement
        ...
        glm::mat4 lightView = glm::lookAt(glm::vec3(0.0f, 80.0f, 0.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
        glm::mat4 lightSpaceMatrix = lightProjection * lightView;

        renderDepthPass(lightSpaceMatrix, depthMapFBO);
        ...
        renderSceneWithShadows(viewProjection, lightSpaceMatrix, depthMap);
